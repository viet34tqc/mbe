...
class ALContactInfo extends WP_Widget_Text {
	...
	public function __construct() {
		...
		WP_Widget::__construct( 'eci', __( '[Auto Listings] Contact Info', 'erocket' ), $widget_ops, $control_ops );
	...
	private function output_svg( $key ) {
		echo file_get_contents( get_stylesheet_directory() . "/img/$key.svg" );
	}
}
